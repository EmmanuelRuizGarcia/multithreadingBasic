...
namespace multithreadingBasic
{
    public partial class MainWindow : Window
    {
        ...
        private void ActivateBGWorker()
        {
            ...
            BGWorker2.RunWorkerCompleted += WorkComplete2; // Update the result when DoWork is done.
        ...
        /// <param name="sender">The caller object.</param>
        /// <param name="e">The arguments.</param>
        private void WorkComplete2(object sender, RunWorkerCompletedEventArgs e)
        {
